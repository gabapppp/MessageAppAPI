...
from .models import UserGroup, MessagingGroup, Message, UserMessage, GroupMessage, Notification
...
class NestedGroupSerializer(serializers.ModelSerializer):
    username = serializers.SlugRelatedField(source='user', slug_field='username', queryset=get_user_model().objects.all())
...
class MessageSerializer(serializers.ModelSerializer):
    ...
    author_id = serializers.SlugRelatedField(source='author', slug_field='id', queryset=get_user_model().objects.all())
...
class UserMessageSerializer(serializers.ModelSerializer):
    ...
    recipient_id = serializers.PrimaryKeyRelatedField(source='user', queryset=get_user_model().objects.all())
